      ...
      <div className="grid min-h-0 flex-1 grid-cols-1 items-stretch gap-3 landscape:grid-cols-[minmax(0,2fr)_minmax(0,3fr)] landscape:gap-3">
        ...
        <div className="flex min-h-0 flex-col gap-1">
          ...
          <div className="relative shrink-0 overflow-hidden rounded-2xl border border-teal-200/90 bg-gradient-to-br from-brand-navy via-teal-800 to-teal-600 px-5 py-5 text-center shadow-lg ring-1 ring-teal-300/50 sm:px-6 sm:py-6">
            ...
            <p className="relative text-xs font-bold uppercase tracking-[0.2em] text-teal-100 sm:text-sm">
              Better Vision After Surgery
            </p>
            <p className="relative mt-2 text-3xl font-black leading-none tracking-tight text-white sm:text-4xl">
              {VA_612_OR_BETTER_PERCENT}%
              <span className="ml-2.5 text-lg font-bold text-teal-100 sm:text-xl">success rate</span>
            </p>
            <p className="relative mt-2 text-[11px] font-medium text-teal-50/85 sm:text-xs">
              Specialist outcomes at Woodlands Hospital
            </p>
          </div>

          <p className="shrink-0 pt-0.5 text-center text-[9px] leading-snug text-slate-400 sm:text-[10px]">
