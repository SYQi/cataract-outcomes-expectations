...
export function VaPrePostCompare({ visualAcuity, animate = true }: VaPrePostCompareProps) {
  ...
  return (
    <div className="grid min-h-0 flex-1 grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-3">
      <div
        className={`relative min-h-[140px] overflow-hidden rounded-xl border-2 bg-slate-100 transition-[border-color,box-shadow,opacity] duration-500 sm:min-h-[160px] ${
      ...
      <div
        className={`relative min-h-[140px] overflow-hidden rounded-xl border-2 bg-slate-100 transition-[border-color,box-shadow,opacity] duration-700 sm:min-h-[160px] ${
          postOpRevealed
      ...
      >
        <div className="absolute inset-0 flex items-center justify-center p-3 sm:p-4">
          <div
            className="max-w-[220px] transition-[filter,opacity] duration-700 sm:max-w-[280px]"
            style={{
