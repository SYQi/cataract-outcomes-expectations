...
export function RefractiveOutcomePage({ onBack, onNext }: RefractiveOutcomePageProps) {
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center gap-3 landscape:grid landscape:grid-cols-[auto_1fr] landscape:items-center landscape:gap-3 sm:gap-3">
        <div className="flex shrink-0 justify-center">
          <div
            className={`relative flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-br from-brand-navy to-teal-600 shadow-xl landscape:h-[4.5rem] landscape:w-[4.5rem] sm:h-32 sm:w-32 ${
        ...
        <div className="min-h-0 w-full shrink-0">
          <div className="min-h-[100px] landscape:min-h-0 landscape:h-[38vh] sm:min-h-[150px]">
            <OutcomeTrendChart
