    ...
    >
      <div className="flex h-full min-h-0 flex-col gap-2 sm:gap-3">
        ...
        >
          ...
          <div className="mx-auto mt-4 flex max-w-sm items-end justify-center gap-3 sm:max-w-md sm:gap-4">
            <div className="flex w-[45%] flex-col items-center">
              <p className="mb-1 h-5 text-[10px] font-semibold text-amber-800 sm:text-xs">
              ...
              <div className="mt-2 flex h-10 items-start justify-center px-0.5">
                <p className="text-center text-[9px] font-bold leading-tight text-amber-900 sm:text-[10px]">
            ...
            <div className="flex w-[45%] flex-col items-center">
              <p className="mb-1 h-5 text-[10px] font-bold text-brand-navy sm:text-xs">
                {COMPLICATION_RATE_PERCENT}%
              </p>
              <div className="relative h-32 w-full sm:h-36">
        ...
        <div className="shrink-0 border-t border-slate-200 pt-2 text-left text-[9px] leading-snug text-slate-500 sm:text-[10px]">
